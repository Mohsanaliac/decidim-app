...
/* harmony import */ var d3_selection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! d3-selection */ "./node_modules/d3-selection/src/mouse.js");
...
/* harmony import */ var d3_selection__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! d3-selection */ "./node_modules/d3-selection/src/touch.js");
/* harmony import */ var d3_selection__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! d3-selection */ "./node_modules/d3-selection/src/selection/on.js");
/* harmony import */ var _nodrag_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./nodrag.js */ "./node_modules/d3-drag/src/nodrag.js");
/* harmony import */ var _noevent_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./noevent.js */ "./node_modules/d3-drag/src/noevent.js");
/* harmony import */ var _constant_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./constant.js */ "./node_modules/d3-drag/src/constant.js");
/* harmony import */ var _event_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./event.js */ "./node_modules/d3-drag/src/event.js");
...
function defaultFilter() {
  return !d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.ctrlKey && !d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.button;
}
...
function defaultSubject(d) {
  return d == null ? {x: d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.x, y: d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.y} : d;
}
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  function mousedowned() {
    ...
    var gesture = beforestart("mouse", container.apply(this, arguments), d3_selection__WEBPACK_IMPORTED_MODULE_1__["default"], this, arguments);
    if (!gesture) return;
    (0,d3_selection__WEBPACK_IMPORTED_MODULE_2__["default"])(d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.view).on("mousemove.drag", mousemoved, true).on("mouseup.drag", mouseupped, true);
    (0,_nodrag_js__WEBPACK_IMPORTED_MODULE_5__["default"])(d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.view);
    (0,_noevent_js__WEBPACK_IMPORTED_MODULE_6__.nopropagation)();
    mousemoving = false;
    mousedownx = d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.clientX;
    mousedowny = d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.clientY;
    gesture("start");
  }

  function mousemoved() {
    (0,_noevent_js__WEBPACK_IMPORTED_MODULE_6__["default"])();
    if (!mousemoving) {
      var dx = d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.clientX - mousedownx, dy = d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.clientY - mousedowny;
  ...
  function mouseupped() {
    (0,d3_selection__WEBPACK_IMPORTED_MODULE_2__["default"])(d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.view).on("mousemove.drag mouseup.drag", null);
    (0,_nodrag_js__WEBPACK_IMPORTED_MODULE_5__.yesdrag)(d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.view, mousemoving);
    (0,_noevent_js__WEBPACK_IMPORTED_MODULE_6__["default"])();
    gestures.mouse("end");
  }
  ...
  function touchstarted() {
    ...
    var touches = d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.changedTouches,
        c = container.apply(this, arguments),
        n = touches.length, i, gesture;

    for (i = 0; i < n; ++i) {
      if (gesture = beforestart(touches[i].identifier, c, d3_selection__WEBPACK_IMPORTED_MODULE_3__["default"], this, arguments)) {
        (0,_noevent_js__WEBPACK_IMPORTED_MODULE_6__.nopropagation)();
        gesture("start");
      }
    }
  ...
  function beforestart(id, container, point, that, args) {
    ...
    if (!(0,d3_selection__WEBPACK_IMPORTED_MODULE_4__.customEvent)(new _event_js__WEBPACK_IMPORTED_MODULE_8__["default"](drag, "beforestart", s, id, active, p[0], p[1], 0, 0, sublisteners), function() {
      if ((d3_selection__WEBPACK_IMPORTED_MODULE_4__.event.subject = s = subject.apply(that, args)) == null) return false;
      dx = s.x - p[0] || 0;
      dy = s.y - p[1] || 0;
      return true;
    })) return;
    ...
    return function gesture(type) {
      ...
      (0,d3_selection__WEBPACK_IMPORTED_MODULE_4__.customEvent)(new _event_js__WEBPACK_IMPORTED_MODULE_8__["default"](drag, type, s, id, n, p[0] + dx, p[1] + dy, p[0] - p0[0], p[1] - p0[1], sublisteners), sublisteners.apply, sublisteners, [type, that, args]);
    };
  }

  drag.filter = function(_) {
    return arguments.length ? (filter = typeof _ === "function" ? _ : (0,_constant_js__WEBPACK_IMPORTED_MODULE_7__["default"])(!!_), drag) : filter;
  };

  drag.container = function(_) {
    return arguments.length ? (container = typeof _ === "function" ? _ : (0,_constant_js__WEBPACK_IMPORTED_MODULE_7__["default"])(_), drag) : container;
  };

  drag.subject = function(_) {
    return arguments.length ? (subject = typeof _ === "function" ? _ : (0,_constant_js__WEBPACK_IMPORTED_MODULE_7__["default"])(_), drag) : subject;
  };

  drag.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : (0,_constant_js__WEBPACK_IMPORTED_MODULE_7__["default"])(!!_), drag) : touchable;
  };
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  function force(_) {
    var i, n = nodes.length, tree = (0,d3_quadtree__WEBPACK_IMPORTED_MODULE_2__["default"])(nodes, _simulation__WEBPACK_IMPORTED_MODULE_3__.x, _simulation__WEBPACK_IMPORTED_MODULE_3__.y).visitAfter(accumulate);
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(nodes) {
  var simulation,
      ...
      alphaTarget = 0,
      velocityDecay = 0.6,
      forces = (0,d3_collection__WEBPACK_IMPORTED_MODULE_1__.map)(),
      stepper = (0,d3_timer__WEBPACK_IMPORTED_MODULE_2__.timer)(step),
