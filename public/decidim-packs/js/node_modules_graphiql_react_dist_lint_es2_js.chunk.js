...
function validateValue(type, valueAST) {
  ...
  if (type instanceof graphql__WEBPACK_IMPORTED_MODULE_1__.GraphQLNonNull) {
  ...
  if (type instanceof graphql__WEBPACK_IMPORTED_MODULE_1__.GraphQLList) {
  ...
  if (type instanceof graphql__WEBPACK_IMPORTED_MODULE_1__.GraphQLInputObjectType) {
    ...
    Object.keys(type.getFields()).forEach((fieldName) => {
      if (!providedFields[fieldName]) {
        ...
        if (fieldType instanceof graphql__WEBPACK_IMPORTED_MODULE_1__.GraphQLNonNull) {
          fieldErrors.push([
            valueAST,
  ...
  if (type instanceof graphql__WEBPACK_IMPORTED_MODULE_1__.GraphQLEnumType || type instanceof graphql__WEBPACK_IMPORTED_MODULE_1__.GraphQLScalarType) {
