...
/***/ "../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/entrypoints/decidim_assemblies.js":
/*!***********************************************************************************************************************************!*\
  !*** ../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/entrypoints/decidim_assemblies.js ***!
  \***********************************************************************************************************************************/
...
/* harmony import */ var src_decidim_assemblies_assemblies__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/decidim/assemblies/assemblies */ "../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/src/decidim/assemblies/assemblies.js");
...
/* harmony import */ var src_decidim_assemblies_orgchart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/decidim/assemblies/orgchart */ "../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/src/decidim/assemblies/orgchart.js");



// Images
__webpack_require__("../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/images sync recursive ^\\.\\/.*$");

/***/ }),

/***/ "../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/images sync recursive ^\\.\\/.*$":
/*!***********************************************************************************************************************!*\
  !*** ../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/images/ sync ^\.\/.*$ ***!
  \***********************************************************************************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {

var map = {
	"./decidim/assemblies/decidim_assemblies.svg": "../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/images/decidim/assemblies/decidim_assemblies.svg"
};
...
webpackContext.id = "../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/images sync recursive ^\\.\\/.*$";

/***/ }),

/***/ "../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/images/decidim/assemblies/decidim_assemblies.svg":
/*!**************************************************************************************************************************************************!*\
  !*** ../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/images/decidim/assemblies/decidim_assemblies.svg ***!
  \**************************************************************************************************************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
/***/ "../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/src/decidim/assemblies/assemblies.js":
/*!**************************************************************************************************************************************!*\
  !*** ../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/src/decidim/assemblies/assemblies.js ***!
  \**************************************************************************************************************************************/
/***/ (function() {
...
/***/ "../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/src/decidim/assemblies/orgchart.js":
/*!************************************************************************************************************************************!*\
  !*** ../../.rbenv/versions/3.0.6/lib/ruby/gems/3.0.0/gems/decidim-assemblies-0.27.10/app/packs/src/decidim/assemblies/orgchart.js ***!
  \************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var d3_selection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! d3-selection */ "./node_modules/d3-selection/src/selectAll.js");
/* harmony import */ var d3_selection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! d3-selection */ "./node_modules/d3-selection/src/selection/on.js");
...
/* harmony import */ var d3_force__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! d3-force */ "./node_modules/d3-force/src/index.js");
...
var renderOrgCharts = function renderOrgCharts() {
  ...
  var renderChartCollapsibleNetwork = function renderChartCollapsibleNetwork(params) {
    ...
    // main chart object
    var _main = function main(_selection) {
      _selection.each(function scope() {
        ...
        // ########################## HIERARCHY STUFF  #########################
        _hierarchy.root = (0,d3_hierarchy__WEBPACK_IMPORTED_MODULE_4__["default"])(attrs.data.root);

        // ###########################   BEHAVIORS #########################
        var behaviors = {};
        // behaviors.zoom = zoom().scaleExtent([0.75, 100, 8]).on("zoom", zoomed)
        behaviors.drag = (0,d3_drag__WEBPACK_IMPORTED_MODULE_6__["default"])().on("start", dragstarted).on("drag", dragged).on("end", dragended);
        ...
        // ###########################   FORCE STUFF #########################
        var force = {};
        force.link = (0,d3_force__WEBPACK_IMPORTED_MODULE_5__.forceLink)().id(function (d) {
          return d.id;
        });
        force.charge = (0,d3_force__WEBPACK_IMPORTED_MODULE_5__.forceManyBody)().strength(-240);
        force.center = (0,d3_force__WEBPACK_IMPORTED_MODULE_5__.forceCenter)(calc.chartWidth / 2, calc.chartHeight / 2);

        // prevent collide
        force.collide = (0,d3_force__WEBPACK_IMPORTED_MODULE_5__.forceCollide)().radius(function (d) {
        ...
        force.x = (0,d3_force__WEBPACK_IMPORTED_MODULE_5__.forceX)().strength(0.5).x(function (d) {
        ...
        force.y = (0,d3_force__WEBPACK_IMPORTED_MODULE_5__.forceY)().strength(0.5).y(function (d) {
          // if node does not have children and is channel (depth=2) , then position it on parent's coordinate
          if (!d.children && d.depth > 2) {
            if (d.parent) {
              d = d.parent;
        ...
        force.simulation = (0,d3_force__WEBPACK_IMPORTED_MODULE_5__.forceSimulation)().force("link", force.link).force("charge", force.charge).force("center", force.center).force("collide", force.collide).force("x", force.x).force("y", force.y);
        ...
        // drawing containers
        var container = (0,d3_selection__WEBPACK_IMPORTED_MODULE_0__["default"])(this);
        ...
        function update(clickedNode) {
          ...
          enteredNodes.append("text").filter(function (d) {
            ...
            return (0,d3_array__WEBPACK_IMPORTED_MODULE_3__.max)([(d.children || {}).length, (d._children || {}).length]);
          });
        ...
        function dragged(d) {
          ...
          d.fx = d3_selection__WEBPACK_IMPORTED_MODULE_2__.event.x;
          d.fy = d3_selection__WEBPACK_IMPORTED_MODULE_2__.event.y;
        }
        ...
        function freeNodes() {
          (0,d3_selection__WEBPACK_IMPORTED_MODULE_1__["default"])(".node").each(function (n) {
            n.fx = null;
            n.fy = null;
          });
        }
    ...
    // debugging visuals
    _main.debug = function (isDebug) {
      attrs.isDebug = isDebug;
      if (isDebug) {
        if (!window.charts) {
          window.charts = [];
        }
        window.charts.push(_main);
      }
      return _main;
    };

    // exposed update functions
    _main.data = function (value) {
      if (!arguments.length) {
        return attrs.data;
      }
      attrs.data = value;
    ...
    // run  visual
    _main.run = function () {
      (0,d3_selection__WEBPACK_IMPORTED_MODULE_1__["default"])(attrs.container).call(_main);
      return _main;
    };
    _main.filter = function (filterParams) {
      if (!arguments.length) {
