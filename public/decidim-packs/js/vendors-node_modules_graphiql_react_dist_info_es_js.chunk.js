...
/* harmony import */ var _introspection_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./introspection.es.js */ "./node_modules/@graphiql/react/dist/introspection.es.js");
/* harmony import */ var _forEachState_es_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./forEachState.es.js */ "./node_modules/@graphiql/react/dist/forEachState.es.js");
...
function getTypeInfo(schema, tokenState) {
  ...
  (0,_forEachState_es_js__WEBPACK_IMPORTED_MODULE_2__.f)(tokenState, (state) => {
    var _a, _b;
    switch (state.kind) {
      case "Query":
      case "ShortQuery":
      ...
      case "AliasedField":
        ...
        break;
      case "SelectionSet":
        info.parentType = info.type ? (0,graphql__WEBPACK_IMPORTED_MODULE_0__.getNamedType)(info.type) : null;
        break;
      case "Directive":
      ...
      case "Argument":
        ...
        break;
      case "EnumValue":
        const enumType = info.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_0__.getNamedType)(info.inputType) : null;
        info.enumValue = enumType instanceof graphql__WEBPACK_IMPORTED_MODULE_0__.GraphQLEnumType ? find(enumType.getValues(), (val) => val.value === state.name) : null;
        break;
      case "ListValue":
        const nullableType = info.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_0__.getNullableType)(info.inputType) : null;
        info.inputType = nullableType instanceof graphql__WEBPACK_IMPORTED_MODULE_0__.GraphQLList ? nullableType.ofType : null;
        break;
      case "ObjectValue":
        const objectType = info.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_0__.getNamedType)(info.inputType) : null;
        info.objectFieldDefs = objectType instanceof graphql__WEBPACK_IMPORTED_MODULE_0__.GraphQLInputObjectType ? objectType.getFields() : null;
        break;
      case "ObjectField":
...
function getFieldDef(schema, type, fieldName) {
  if (fieldName === _introspection_es_js__WEBPACK_IMPORTED_MODULE_1__.S.name && schema.getQueryType() === type) {
    return _introspection_es_js__WEBPACK_IMPORTED_MODULE_1__.S;
  }
  if (fieldName === _introspection_es_js__WEBPACK_IMPORTED_MODULE_1__.T.name && schema.getQueryType() === type) {
    return _introspection_es_js__WEBPACK_IMPORTED_MODULE_1__.T;
  }
  if (fieldName === _introspection_es_js__WEBPACK_IMPORTED_MODULE_1__.a.name && (0,graphql__WEBPACK_IMPORTED_MODULE_0__.isCompositeType)(type)) {
    return _introspection_es_js__WEBPACK_IMPORTED_MODULE_1__.a;
  }
...
function getEnumValueReference(typeInfo) {
  return {
    ...
    type: typeInfo.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_0__.getNamedType)(typeInfo.inputType) : void 0
  };
}
...
/* harmony import */ var _index_es_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index.es.js */ "./node_modules/@graphiql/react/dist/index.es.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react */ "./node_modules/react/index-exposed.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react-dom */ "./node_modules/react-dom/index.js");
/* harmony import */ var _introspection_es_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./introspection.es.js */ "./node_modules/@graphiql/react/dist/introspection.es.js");
/* harmony import */ var _forEachState_es_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./forEachState.es.js */ "./node_modules/@graphiql/react/dist/forEachState.es.js");
var __defProp = Object.defineProperty;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });
...
_codemirror_es_js__WEBPACK_IMPORTED_MODULE_1__.C.registerHelper("info", "graphql", (token, options) => {
  ...
  const typeInfo = (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_2__.g)(options.schema, token.state);
...
function renderQualifiedField(into, typeInfo, options) {
  ...
  text(into, fieldName, "field-name", options, (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_2__.a)(typeInfo));
}
...
function renderDirective(into, typeInfo, options) {
  ...
  text(into, name, "directive-name", options, (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_2__.b)(typeInfo));
}
...
function renderArg(into, typeInfo, options) {
  ...
  text(into, "(");
  text(into, name, "arg-name", options, (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_2__.c)(typeInfo));
...
function renderEnumValue(into, typeInfo, options) {
  ...
  text(into, ".");
  text(into, name, "enum-value", options, (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_2__.d)(typeInfo));
}
__name(renderEnumValue, "renderEnumValue");
function renderType(into, typeInfo, options, t) {
  if (t instanceof graphql__WEBPACK_IMPORTED_MODULE_0__.GraphQLNonNull) {
    renderType(into, typeInfo, options, t.ofType);
    text(into, "!");
  } else if (t instanceof graphql__WEBPACK_IMPORTED_MODULE_0__.GraphQLList) {
    text(into, "[");
    renderType(into, typeInfo, options, t.ofType);
    text(into, "]");
  } else {
    text(into, (t === null || t === void 0 ? void 0 : t.name) || "", "type-name", options, (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_2__.e)(typeInfo, t));
  }
}
